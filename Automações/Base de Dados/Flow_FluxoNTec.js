...
<empty_result_recovery>
Se a busca (fileSearch) não retornar cases aplicáveis de imediato, obrigatoriamente tente uma segunda estratégia (ex: buscar pelo macrossetor do lead ou desafios técnicos genéricos como "performance" ou "segurança") antes de admitir que não encontrou dados.
</empty_result_recovery>
...
<empty_result_recovery>
Se a busca inicial (via fileSearch ou web) no contexto da empresa falhar, tente obrigatoriamente uma segunda estratégia (ex: buscar por tecnologias similares ou desafios de integração) antes de admitir que não encontrou informações específicas.
</empty_result_recovery>
