...
const fileSearch = fileSearchTool([
    "vs_68d1adb002b481918d197bbe50ee1974"
])
...
export const runWorkflow = async (workflow: WorkflowInput) => {
    return await withTrace("Fluxo NDados", async () => {
        const state = {
            cadencia: null,
            etapa: null,
        ...
        if (state.cadencia == 'Nurturing') {
            if (state.etapa == 1 || state.etapa == 3 || state.etapa == 5) {
              ...
              CONTEXTO DE E-MAILS ANTERIORES: ${state.emails_anteriores}`
                ...
                return redatorDeNurturingPesquisaResult;
              ...
              CONTEXTO DE E-MAILS ANTERIORES: ${state.emails_anteriores}`
                ...
                return redatorDeNurturingCaseResult;
            } else {
            ...
            if (state.etapa == 1) {
              ...
              CONTEXTO DE E-MAILS ANTERIORES: ${state.emails_anteriores}`
                ...
                return redatorDeRetomadaCasePesquisaResult;
              ...
              CONTEXTO DE E-MAILS ANTERIORES: ${state.emails_anteriores}`
                ...
                return redatorDeRetomadaFupResult;
            } else {
            ...
            return redatorDeReEngajementPSNurturingFupResult;
        } else {
