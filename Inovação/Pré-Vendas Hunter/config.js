...
const CONFIG_STRICT = {
    MAX_RETRIES: 3,
    MAX_BATCH_CATCHUP: 3, // Processa até 3 CSVs se estiver atrasado
    SUCCESS_THRESHOLD: 0.9, // 90% de sucesso exigido
...
const CONFIG = Object.freeze({
    ...
    MAX_EXECUTION_TIME_MS: 1500000, //25min
    ...
    FIELDS: {
        ...
        DEAL_SETOR: '6ea1ea74da5fbb8cb6a8dd741a96a9bc8b4e379f', // Deal Field
        ORIGIN: '97d0502cc2b489986844a93b374656e5acf179e1', // Deal Field
        HUNTER: '2e9e1edaa8c01d43869bc9e949a5873ba2163ca4',  // Deal Field
        ORG_LINKEDIN: 'linkedin', // Org Field
        ORG_WEBSITE: 'website', // Org Field
    ...
    // Apollo to Pipedrive Field Mappings
    APOLLO_TO_SETOR: {
